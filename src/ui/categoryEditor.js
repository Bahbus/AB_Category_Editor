...
export function renderEditor(deps) {
  ...
  if (!cats.length) {
    ...
    root.innerHTML = `
      <div class="card empty-state-card">
        ...
        <ul class="hint">
          ...
          <li><button id="loadSortaKindaPreset" type="button" class="link-button" title="Import bundled SortaKinda preset categories">Load presets based on SortaKinda</button></li>
    ...
    const presetButton = root.querySelector('#loadSortaKindaPreset');
    if (presetButton && typeof loadSortaKindaPreset === 'function') presetButton.addEventListener('click', () => { commitActiveField(); loadSortaKindaPreset(); });
    return;
  }
